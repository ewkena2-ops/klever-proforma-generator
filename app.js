...
function bindFormInputs() {
  ...
  document.getElementById("saveProjectBtn").addEventListener("click", downloadProjectFile);
...
function downloadProjectFile() {
  ...
  link.href = url;
  link.download = `${safeFileName(project.fields.projectId)}_editable_proforma.json`;
...
function normalizeDocType(value) {
  return /amendment/i.test(String(value || "")) ? "Amendment" : "Acknowledgement";
}
